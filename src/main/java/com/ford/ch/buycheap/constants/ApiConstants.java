package com.ford.ch.buycheap.constants;
...
public class ApiConstants
{
	...
	public static final String MESSAGE_FOR_ONE_BOOKING_PER_DAY = "Only one seat can be booked for a day";
	public static final String MESSAGE_FOR_SEAT_ALREADY_BOOKED = "Seat already blocked by ";
